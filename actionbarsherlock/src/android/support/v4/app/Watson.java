...
public abstract class Watson extends com.good.gd.FragmentActivity implements OnCreatePanelMenuListener, OnPreparePanelListener, OnMenuItemSelectedListener {
    ...
    public boolean onCreatePanelMenu(int featureId, Menu menu) {
        ...
        if (featureId == Window.FEATURE_OPTIONS_PANEL) {
            ...
            if (((FragmentManagerImpl)getSupportFragmentManager()).mAdded != null) {
                for (int i = 0; i < ((FragmentManagerImpl)getSupportFragmentManager()).mAdded.size(); i++) {
                    Fragment f = ((FragmentManagerImpl)getSupportFragmentManager()).mAdded.get(i);
